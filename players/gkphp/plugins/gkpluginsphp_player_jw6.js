function(idDivVideo, objVideo) {
    var addPlayer = function(id, a) {
        var jwplayerjs = "https://content.jwplatform.com/libraries/XeGdlzmk.js";
        var jwplayerSwf = "https//ssl.p.jwpcdn.com/player/v/7.3.5/jwplayer.flash.swf";
        var jwplayerKey = "";
        var jwplayerSkin = "";
        ...
        var dsetupjw = function() {
            ...
            if (objVideo.advertising) {
                jwplayer.advertising = objVideo.advertising;
            }
            ...
            playerInstance.onComplete(function() {
                ...
                if($.cookie('AutoNext')=='on'){
                    var cc=$('.episode-list li a.active').parent().next().find('a').attr('href');
                    if(cc!=undefined)
                        document.location.href=cc;
                }
            ...
            playerInstance.addButton(
               ...
               function() {
                ...
                window.open(playerInstance.getPlaylistItem()['sources'][playerInstance.getCurrentQuality()].file+'?type=video/mp4&title=Phim hop', '_blank').blur();
