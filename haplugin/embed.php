				...
				else
				{
					...
					if($type==1)
					{
						...
						(
							'source' => ''.$dataplay.'',
							'skin' => '19',
							'jwkey' => 'Fgvbf/xGYQG05kB2SU4YfEcBSik2EkZCxK2ErTgvfSE=',
							'options' => array
							(
								'autostart' => 'true',
								'mute' => 'false',
							...
							'logo' => array
							(
								'file' => 'http://vuihd.com/newplayer/logo.png',
								'position' => 'top-left',
								'link' => 'http://vuihd.com',
								'abouttext' => 'VuiHD.COM Premium Player',
								'aboutlink' => 'http://vuihd.com',
							),
							/*'resize' => array
							(
								'szoom' => '640',
