	 ...
	 //--Film
		...
		$contentHtmlz = 'Xin chào '.$name.',';
            if($data_cache != null){
		        ...
		        $contentHtml = '<br><br>
			Bạn nhận được email này vì bạn đã theo dõi phim trên Hayxemphim.net.<br><br>
			...
			<br>
			Thân !<br>
			<b>Hayxemphim.net</b>, Website xem phim trực tuyến miễn phí !<br>
			Website: <a href="http://hayxemphim.net" target="_blank">http://hayxemphim.net</a><br>
			Facebook: <a href="https://www.facebook.com/hayxemphimnet/" target="_blank">http://www.facebook.com/<wbr>hayxemphimnet</a><br><br>
			<i>Trường hợp hệ thống liên tục gửi email thông báo cho bạn với nội dung giống nhau thì rất có thể đang bị lỗi, nếu bạn không phiền có thể bỏ chút thời gian báo lỗi khẩn cấp đến email <a href="mailto:nhacmoitk@gmail.com" target="_blank">nhacmoitk@gmail.com</a> để chúng tôi khắc phục. Cám ơn các bạn.</i>';
            $phpFastCache->set($key, $contentHtml, CACHED_TIME);
            }
		$contentHtml = 'Xin chào '.$name.','.$contentHtml;
        $mail->CharSet = "UTF-8";
        $mail->FromName = "Hayxemphim.net Notifier"; // Name to indicate where the email came from when the recepient received
        $mail->AddAddress($to,"Hayxemphim.net Notifier");
        $mail->AddReplyTo(EMAIL_REPLY,"Hayxemphim.net Notifier");
